...
function streamConnect(retryAttempt: any) {
    ...
    stream.on('data', async (data: any) => {
        try {
            ...
            const updatedData = { ...json, link: `https://twitter.com/dosukoitintin/status/${json.data.id}` }
            console.log(updatedData);
            mailOptions.text = JSON.stringify(updatedData.data.text + " \n " + updatedData.link);
            //Sending email
